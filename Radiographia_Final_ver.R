...
myRadiographia <- raster("C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\X.tif")
...
time <- X                        # Select exposition period in hours (0.5, 1, 7.5, 16, 21, 24, 48, 72, 96)
...
writeRaster(r2, "C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\pre_X.tif", dataType = "INT2U")
...
write_xlsx(polygon@data,"C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\X.xlsx")
