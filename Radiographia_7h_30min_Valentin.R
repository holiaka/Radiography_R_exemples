...
myRadiographia <- raster("C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Particles_7h_30m.tif")
...
time <- 7.5                        # Select exposition period in hours (0.5, 1, 7.5, 16, 21, 24, 48, 72, 96)
working_name <- "Particles_7h_30min"
dpi <- 508
resize_pixels <- 10
fon_level <- 720
detect_level_for_part <- 1306
focal_filter <- 9
max_local_filter <- 20
sample_weigth_g <- 4.5
...
writeRaster(r2, "C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\pre_Particles_7h_30m.tif", dataType = "INT2U")
...
write_xlsx(polygon@data,"C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Particles_7h_30m.xlsx")
