...
myRadiographia <- raster("C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Liquid_Sr&Cs_25h.tif")
...
working_name <- "Liquid_Sr&Cs_25h"
dpi <- 508
resize_pixels <- 10
fon_level <- 450
detect_level_for_part <- 1800
focal_filter <- 15
max_local_filter <- 300
sample_weigth_g <- 0.15
...
writeRaster(r2, "C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\pre_Liquid_Sr&Cs_25h.tif", dataType = "INT2U")
...
write_xlsx(polygon@data,"C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Liquid_Sr&Cs_25h.xlsx")
