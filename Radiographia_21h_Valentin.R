...
myRadiographia <- raster("C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Particles_21h.tif")
...
time <- 21                        # Select exposition period in hours (0.5, 1, 7.5, 16, 21, 24, 48, 72, 96)
working_name <- "Particles_21h"
dpi <- 508
resize_pixels <- 10
fon_level <- 2000
...
writeRaster(r2, "C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\pre_Particles_21h.tif", dataType = "INT2U")
...
write_xlsx(polygon@data,"C:\\Users\\D Holiaka\\Documents\\GitHub\\Radiography_R_exemples\\Particles_21h.xlsx")
